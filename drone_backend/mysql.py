...
class MysqlProcessor:
    ...
    def add_device(self, device_info):
        ...
        if Drone.objects.filter(id=device_info['id']).exists():
            ...
            device_mysql = Drone(id=device_info['id'], latitude=device_info['latitude'], longitude=device_info['longitude'], time=device_info['timestamp'], dist_id=device_info['district'], video_url=device_info['video_url'])
            device_mysql.save()
            return True
